...
unsafe extern "C" {
    pub fn rocksdb_multi_get_with_ts(
        ...
        values_list: *mut *mut ::std::os::raw::c_char,
        values_list_sizes: *mut usize,
        timestamp_list: *mut *mut ::std::os::raw::c_char,
...
unsafe extern "C" {
    pub fn rocksdb_multi_get_cf_with_ts(
        ...
        values_list: *mut *mut ::std::os::raw::c_char,
        values_list_sizes: *mut usize,
        timestamps_list: *mut *mut ::std::os::raw::c_char,
...
unsafe extern "C" {
    pub fn rocksdb_load_latest_options(
        ...
        column_family_names: *mut *mut *mut ::std::os::raw::c_char,
...
unsafe extern "C" {
    pub fn rocksdb_load_latest_options_destroy(
        ...
        list_column_family_names: *mut *mut ::std::os::raw::c_char,
...
unsafe extern "C" {
    pub fn rocksdb_block_based_options_set_optimize_filters_for_memory(
        options: *mut rocksdb_block_based_table_options_t,
        optimize_filters_for_memory: ::std::os::raw::c_uchar,
    );
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_options_set_statistics_level(
        arg1: *mut rocksdb_options_t,
        level: ::std::os::raw::c_int,
    );
}
unsafe extern "C" {
    pub fn rocksdb_options_get_statistics_level(
        arg1: *mut rocksdb_options_t,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_options_get_blob_file_starting_level(
        opt: *mut rocksdb_options_t,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_options_get_prepopulate_blob_cache(
        opt: *mut rocksdb_options_t,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_options_set_wal_compression(
        opt: *mut rocksdb_options_t,
        arg1: ::std::os::raw::c_int,
    );
}
unsafe extern "C" {
    pub fn rocksdb_options_get_wal_compression(
        opt: *mut rocksdb_options_t,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_comparator_with_ts_create(
        ...
        compare_ts: ::std::option::Option<
            unsafe extern "C" fn(
                arg1: *mut ::std::os::raw::c_void,
                a_ts: *const ::std::os::raw::c_char,
                a_tslen: usize,
                b_ts: *const ::std::os::raw::c_char,
                b_tslen: usize,
            ) -> ::std::os::raw::c_int,
        >,
        compare_without_ts: ::std::option::Option<
            unsafe extern "C" fn(
                ...
                a: *const ::std::os::raw::c_char,
                alen: usize,
                a_has_ts: ::std::os::raw::c_uchar,
                b: *const ::std::os::raw::c_char,
                blen: usize,
                b_has_ts: ::std::os::raw::c_uchar,
            ) -> ::std::os::raw::c_int,
        >,
        name: ::std::option::Option<
            unsafe extern "C" fn(
...
unsafe extern "C" {
    pub fn rocksdb_readoptions_set_async_io(
        arg1: *mut rocksdb_readoptions_t,
        arg2: ::std::os::raw::c_uchar,
    );
}
unsafe extern "C" {
    pub fn rocksdb_readoptions_get_async_io(
        arg1: *mut rocksdb_readoptions_t,
    ) -> ::std::os::raw::c_uchar;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_ingestexternalfileoptions_set_fail_if_not_bottommost_level(
        opt: *mut rocksdb_ingestexternalfileoptions_t,
        fail_if_not_bottommost_level: ::std::os::raw::c_uchar,
    );
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_fifo_compaction_options_set_allow_compaction(
        ...
        allow_compaction: ::std::os::raw::c_uchar,
    );
}
unsafe extern "C" {
